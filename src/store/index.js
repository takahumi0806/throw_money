...
const store = new Vuex.Store({
  ...
  actions: {
    ...
    signUp({ commit }, password) {
      firebase
        .auth()
        .createUserWithEmailAndPassword(password.userMail, password.password)
        .then((user) => {
          db.settings({
    ...
    signIn({ commit }, passwaord) {
      firebase
        .auth()
        .signInWithEmailAndPassword(passwaord.userMail, passwaord.password)
        .then(() => {
